...
<head>
  <?= $this->element('title_meta', array('logo2' => true)) ?>
...
<body class="body-bg2">
        ...
        <div class="col-lg-6">
          <div class="hero2-header heading3">
            ...
            <div class="btn-area1" data-aos="fade-left" data-aos-duration="1200">
              <a href="contact" class="vl-btn3"><span class="demo">Boost Your Customer Support</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></a>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
                ...
                <div class="images">
                  ...
                  <div class="arrow-circle text-end">
                    <a href="#">
                      ...
                      <img src="/img/icons/arrow1.svg" alt="" class="arrow1"></a>
                  </div>
  ...
  <!--===== SERVICE AREA STARTS =======-->
  <div class="service2-section-area sp1">
    <div class="container">
      <div class="row">
                    ...
                    <div class="service-boxarea">
                      ...
                      <div class="content-area">
                        ...
                        <div class="btn-area" data-aos="fade-left" data-aos-duration="1000">
                          <a href="service" class="vl-btn3"><span class="demo">Learn More</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="vl-blog-1-item">
            ...
            <div class="vl-blog-1-content">
              <div class="vl-blog-meta">
                <ul>
                  <li><a href="#"><img src="/img/icons/calender1.svg" alt=""> 4 August 2024</a></li>
                </ul>
              </div>
              <div class="space16"></div>
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-right" data-aos-duration="1000">
          <div class="vl-blog-1-item">
            ...
            <div class="vl-blog-1-content">
              <div class="vl-blog-meta">
                <ul>
                  <li><a href="#"><img src="/img/icons/calender1.svg" alt=""> 5 August 2024</a></li>
                </ul>
              </div>
              <div class="space16"></div>
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-right" data-aos-duration="1000">
          <div class="vl-blog-1-item">
            ...
            <div class="vl-blog-1-content">
              <div class="vl-blog-meta">
                <ul>
                  <li><a href="#"><img src="/img/icons/calender1.svg" alt=""> 6 August 2024</a></li>
                </ul>
              </div>
              <div class="space16"></div>
        ...
        <div class="col-lg-4">
          <div class="cta-images">
            ...
            <ul class="aniamtion-key-1">
              <li><a href="#"><img src="/img/icons/check2.svg" alt="">IT Solution Services</a></li>
              <li><a href="#"><img src="/img/icons/check2.svg" alt="">Cyber Security Services</a></li>
              <li><a href="#"><img src="/img/icons/check2.svg" alt="">Software Development</a></li>
            </ul>
          </div>
        </div>
      </div>
