        ...
        <div class="container headerfix">
            <div class="row align-items-center row-bg2">
                <div class="col-lg-2 col-md-6 col-6">
                    <div class="vl-logo">
                        <a href="index"><img src="/img/logo/logo3.png" alt=""></a>
                    </div>
                </div>
                            ...
                            <ul>
                                            ...
                                            <div class="row gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <div class="btn-area1">
                                                            <a href="index" class="vl-btn3"><span class="demo">Multi Page</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span> </a>
                                                            <div class="space16"></div>
                                                            <a href="single-index1" target="_blank" class="vl-btn3"><span class="demo">One page</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span> </a>
                                                        </div>
                                                ...
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <div class="btn-area1">
                                                            <a href="index2" class="vl-btn3"><span class="demo">Multi Page</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span> </a>
                                                            <div class="space16"></div>
                                                            <a href="single-index2" target="_blank" class="vl-btn3"><span class="demo">One Page</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span> </a>
                                                        </div>
                                                        <div class="space20 d-lg-none d-block"></div>
                                                    </div>
                                                </div>
                                                <div class="col ">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <div class="btn-area1">
                                                            <a href="index3" class="vl-btn3"><span class="demo">Multi Page</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span> </a>
                                                            <div class="space16"></div>
                                                            <a href="single-index3" target="_blank" class="vl-btn3"><span class="demo">One page</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span> </a>
                                                        </div>
                                                        <div class="space20 d-lg-none d-block"></div>
                                                    </div>
                                                </div>
                                                <div class="col ">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <div class="btn-area1">
                                                            <a href="index4" class="vl-btn3"><span class="demo">Multi Page</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span> </a>
                                                            <div class="space16"></div>
                                                            <a href="single-index4" target="_blank" class="vl-btn3"><span class="demo">One Page</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span> </a>
                                                        </div>
                                                        <div class="space20 d-lg-none d-block"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col ">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <div class="btn-area1">
                                                            <a href="index5" class="vl-btn3"><span class="demo">Multi Page</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span> </a>
                                                            <div class="space16"></div>
                                                            <a href="single-index5" target="_blank" class="vl-btn3"><span class="demo">One Page</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span> </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li><a href="#">Blogs <span><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="#" class="span-arrow">Blog Sidebar <span><i class="fa-solid fa-angle-right d-lg-block d-none"></i></span></a>
                                            <ul class="sub-menu menu1">
                                                <li><a href="blog-leftv1">Blog Left V1</a></li>
                                                <li><a href="blog-leftv2">Blog Left V2</a></li>
                                                <li><a href="blog-rightv1">Blog Right V1</a></li>
                                                <li><a href="blog-rightv2">Blog Right V2</a></li>
                                            </ul>
                                        </li>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="vl-hero-btn d-none d-lg-block text-end">
                        <span class="vl-btn-wrap text-end">
                            <a href="contact" class="vl-btn3"><span class="demo">Get In Touch</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span> </a>
                        </span>
                    </div>
