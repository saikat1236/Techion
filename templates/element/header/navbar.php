                                          ...
                                          <div class="row gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                                              <div class="col">
                                                      <div class="vl-home-thumb">
                                                         ...
                                                         <div class="btn-area1">
                                                          <a href="index" class="vl-btn1">Multi Page</a>
                                                          <div class="space16"></div>
                                                          <a href="single-index1" target="_blank" class="vl-btn1">One Page</a>
                                                         </div>
                                              ...
                                              <div class="col">
                                                      <div class="vl-home-thumb">
                                                        ...
                                                        <div class="btn-area1">
                                                          <a href="index2" class="vl-btn1">Multi Page</a>
                                                          <div class="space16"></div>
                                                          <a href="single-index2" target="_blank" class="vl-btn1">One Page</a>
                                                         </div>
                                                        <div class="space20 d-lg-none d-block"></div>
                                                      </div>
                                              </div>
                                              <div class="col ">
                                                      <div class="vl-home-thumb">
                                                        ...
                                                        <div class="btn-area1">
                                                          <a href="index3" class="vl-btn1">Multi Page</a>
                                                          <div class="space16"></div>
                                                          <a href="single-index3" target="_blank" class="vl-btn1">One Page</a>
                                                         </div>
                                                        <div class="space20 d-lg-none d-block"></div>
                                                      </div>
                                              </div>
                                              <div class="col ">
                                                      <div class="vl-home-thumb">
                                                        ...
                                                        <div class="btn-area1">
                                                          <a href="index4" class="vl-btn1">Multi Page</a>
                                                          <div class="space16"></div>
                                                          <a href="single-index4" target="_blank" class="vl-btn1">One Page</a>
                                                         </div>
                                                        <div class="space20 d-lg-none d-block"></div>
                                                      </div>
                                              </div>
                                              ...
                                              <div class="col ">
                                                    <div class="vl-home-thumb">
                                                      ...
                                                      <div class="btn-area1">
                                                        <a href="index5" class="vl-btn1">Multi Page</a>
                                                        <div class="space16"></div>
                                                        <a href="single-index5" target="_blank" class="vl-btn1">One Page</a>
                                                       </div>
                                                    </div>
                                            </div>
                                          </div>
              ...
              <div class="col-lg-3 col-md-6 col-6">
                  <div class="vl-hero-btn d-none d-lg-block text-end">
                          <span class="vl-btn-wrap text-end">
                            <a href="contact" class="vl-btn1">Get Started Now <i class="fa-solid fa-arrow-right"></i></a>
                          </span>
                  </div>
