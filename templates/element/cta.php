    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <div class="cta-images">
          ...
          <div class="img1">
            <img src="/img/all-images/cta/cta-img1.png" alt="">
          </div>
          <ul class="aniamtion-key-1">
            <li><a href="#"><img src="/img/icons/check5.svg" alt="">IT Solution Services</a></li>
            <li><a href="#"><img src="/img/icons/check5.svg" alt="">Cyber Security Services</a></li>
            <li><a href="#"><img src="/img/icons/check5.svg" alt="">Software Development</a></li>
          </ul>
        </div>
      </div>
    </div>
