        ...
        <div class="col-lg-5">
          <div class="about-header-area heading2">
            ...
            <div class="btn-area1" data-aos="fade-left" data-aos-duration="1200">
              <a href="contact" class="vl-btn2">See How We Can Help <i class="fa-solid fa-arrow-right"></i></a>
            </div>
          </div>
        </div>
      </div>
...
<div class="row">
      ...
      <div class="row align-items-center">
        <div class="col-lg-5">
          <div class="solution-header heading2">
            ...
            <div class="space32"></div>
            <div class="btn-area1" data-aos="fade-left" data-aos-duration="1000">
              <a href="contact" class="vl-btn2">Discover Our Solutions <i class="fa-solid fa-arrow-right"></i></a>
            </div>
          </div>
        </div>
  ...
  <!--===== WORK AREA STARTS =======-->
  <div class="work-others-section" style="background-image: url(/img/all-images/bg/hero-bg1.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="btn-area1 text-center">
            <a href="blog1" class="vl-btn2">Read More Blog And News <i class="fa-solid fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
