...
<body>
    ...
    <?= $this->element("header-single/navbar4") ?>
    ...
    <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary rounded-2" tabindex="0">
        ...
        <!--===== ABOUT AREA STARTS =======-->
        <div class="about4-section-area sp1" id="about">
                        ...
                        <div class="col-lg-5">
                            <div class="about-header heading6">
                                ...
                                <div class="btn-area1" data-aos="fade-left" data-aos-duration="1000">
                                    <a href="contact" class="vl-btn5"><span class="demo">Request A Free Consultation</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!--===== SERVICE AREA STARTS =======-->
        <div class="service4-section-area sp1" id="service" style="background-image: url(/img/all-images/bg/service-bg1.png); background-position: center; background-size: cover; background-repeat: no-repeat;">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="service-header space-margin60">
                            ...
                            <div class="btn-area1">
                                <a href="service" class="vl-btn5"><span class="demo">View More Services</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!--===== WORKS AREA STARTS =======-->
        <div class="work4-section-area sp1" id="work">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-4">
                                        <div class="card-boxarea box1" data-aos="zoom-in" data-aos-duration="800">
                                            ...
                                            <div class="content-area">
                                                <a href="service-single">Discovery Consultation</a>
                                        ...
                                        <div class="card-boxarea box2" data-aos="zoom-in" data-aos-duration="900">
                                            <div class="content-area">
                                                <a href="service-single">Customized IT Strategy</a>
                                                <div class="space14"></div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card-boxarea box3" data-aos="zoom-in" data-aos-duration="800">
                                            ...
                                            <div class="content-area2">
                                                <a href="service-single">Quality Assurance</a>
                                                <div class="space14"></div>
                                        ...
                                        <div class="card-boxarea box4" data-aos="zoom-in" data-aos-duration="1000">
                                            <div class="content-area2">
                                                <a href="service-single">24/7 Support</a>
                                                <div class="space14"></div>
        ...
        <!--===== CASE AREA STARTS =======-->
        <div class="case4-section-area sp1" id="case" style="background-image: url(/img/all-images/bg/service-bg1.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
            <img src="/img/elements/elements41.png" alt="" class="elements41">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                    ...
                    <div class="col-lg-12">
                        <div class="case4-slider owl-carousel">
                            <div class="case-single-boxarea">
                                ...
                                <div class="content-area">
                                    <a href="service-single"><span>#CloudFlex Solution</span></a>
                                    <div class="space16"></div>
                                    <a href="service-single">Enhancing Productivity To with CloudFlex Solutions</a>
                                    <div class="arrow">
                            ...
                            <div class="case-single-boxarea">
                                ...
                                <div class="content-area">
                                    <a href="service-single"><span>#Network Optimization</span></a>
                                    <div class="space16"></div>
                                    <a href="service-single">Business Continuity with An BackupShield Data Recovery</a>
                                    <div class="arrow">
                            ...
                            <div class="case-single-boxarea">
                                ...
                                <div class="content-area">
                                    ...
                                    <div class="space16"></div>
                                    <a href="service-single">Strengthening Security with A TechGuard Cybersecurity</a>
                                    <div class="arrow">
                                        <a href="service-single"><i class="fa-solid fa-arrow-right"></i></a>
                                    </div>
                                </div>
        ...
        <!--===== PRICING AREA STARTS =======-->
        <div class="pricing4-section-area sp2" id="pricing">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 m-auto">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6" data-aos="flip-right" data-aos-duration="800">
                        <div class="pricing-single-boxarea">
                            ...
                            <h3>Basic Plan</h3>
                            <ul>
                                <li><img src="/img/icons/check6.svg" alt="">Tailored IT Solutions</li>
                                <li><img src="/img/icons/check6.svg" alt="">Proactive System Monitoring</li>
                                <li><img src="/img/icons/check6.svg" alt="">Scalable Cloud Solutions</li>
                                <li><img src="/img/icons/check6.svg" alt="">Cybersecurity Protection</li>
                                <li><img src="/img/icons/check6.svg" alt="">Secure Data Backup & Recovery</li>
                                <li><img src="/img/icons/check6.svg" alt="">Custom Software Development</li>
                                <li><img src="/img/icons/check6.svg" alt="">IT Infrastructure Management</li>
                                <li><img src="/img/icons/check6.svg" alt="">Data Encryption & Compliance</li>
                            </ul>
                            <div class="space32"></div>
                            <div class="btn-area1">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="flip-left" data-aos-duration="1000">
                        ...
                        <div class="pricing-single-boxarea box2">
                            ...
                            <h3>Pro Plan</h3>
                            <ul>
                                <li><img src="/img/icons/check7.svg" alt="">Tailored IT Solutions</li>
                                <li><img src="/img/icons/check7.svg" alt="">Proactive System Monitoring</li>
                                <li><img src="/img/icons/check7.svg" alt="">Scalable Cloud Solutions</li>
                                <li><img src="/img/icons/check7.svg" alt="">Cybersecurity Protection</li>
                                <li><img src="/img/icons/check7.svg" alt="">Secure Data Backup & Recovery</li>
                                <li><img src="/img/icons/check7.svg" alt="">Custom Software Development</li>
                                <li><img src="/img/icons/check7.svg" alt="">IT Infrastructure Management</li>
                                <li><img src="/img/icons/check7.svg" alt="">Data Encryption & Compliance</li>
                            </ul>
                            <div class="space32"></div>
                            <div class="btn-area1">
                                <a href="#" class="vl-btn5"><span class="demo">Choose A Plan</span><span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></a>
        ...
        <div class="testimonial4-section-area sp1" id="testimonial" style="background-image: url(/img/all-images/bg/service-bg1.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
        ...
        <!--===== BLOG AREA STARTS =======-->
        <div class="vl-blog-4-area sp2" id="blog">
                        ...
                        <div class="vl-blog-1-item">
                            ...
                            <div class="vl-blog-1-content">
                                <div class="vl-blog-meta">
                                    <ul>
                                        <li><a href="#"><img src="/img/icons/calender2.svg" alt=""> 4 August 2024</a></li>
                                    </ul>
                                </div>
                                <div class="space16"></div>
                                <h4 class="vl-blog-1-title"><a href="blog-single">How to Choose the Right BPO Partner for Your Best Business</a></h4>
                                <div class="space20"></div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-right" data-aos-duration="1000">
                        <div class="vl-blog-1-item">
                            ...
                            <div class="vl-blog-1-content">
                                <div class="vl-blog-meta">
                                    <ul>
                                        <li><a href="#"><img src="/img/icons/calender2.svg" alt=""> 5 August 2024</a></li>
                                    </ul>
                                </div>
                                <div class="space16"></div>
                                <h4 class="vl-blog-1-title"><a href="blog-single">The Future of BPO: Trends On Shaping A Customer Support</a></h4>
                                <div class="space20"></div>
                                <a href="blog-single" class="readmore">Learn More <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-right" data-aos-duration="1000">
                        <div class="vl-blog-1-item">
                            ...
                            <div class="vl-blog-1-content">
                                <div class="vl-blog-meta">
                                    <ul>
                                        <li><a href="#"><img src="/img/icons/calender2.svg" alt=""> 6 August 2024</a></li>
                                    </ul>
                                </div>
                                <div class="space16"></div>
                                <h4 class="vl-blog-1-title"><a href="blog-single">From Data to Decisions: Using Analytic Call Centre Operation</a></h4>
                                <div class="space20"></div>
                                <a href="blog-single" class="readmore">Learn More <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
