                                              ...
                                              <div class="col">
                                                      <div class="vl-home-thumb">
                                                         ...
                                                         <div class="btn-area1">
                                                          ...
                                                          <a href="single-index1" target="_blank" class="vl-btn6">One Page <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                                                         </div>
                                              ...
                                              <div class="col">
                                                      <div class="vl-home-thumb">
                                                        ...
                                                        <div class="btn-area1">
                                                          ...
                                                          <div class="space16"></div>
                                                          <a href="single-index2" target="_blank" class="vl-btn6">One Page <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                                                         </div>
                                                        <div class="space20 d-lg-none d-block"></div>
                                                      </div>
                                              </div>
                                              <div class="col ">
                                                      <div class="vl-home-thumb">
                                                        ...
                                                        <div class="btn-area1">
                                                          ...
                                                          <div class="space16"></div>
                                                          <a href="single-index3" target="_blank" class="vl-btn6">One Page <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                                                         </div>
                                                        <div class="space20 d-lg-none d-block"></div>
                                                      </div>
                                              </div>
                                              <div class="col ">
                                                      <div class="vl-home-thumb">
                                                        ...
                                                        <div class="btn-area1">
                                                          ...
                                                          <div class="space16"></div>
                                                          <a href="single-index4" target="_blank" class="vl-btn6">One Page <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                                                         </div>
                                                        <div class="space20 d-lg-none d-block"></div>
                                                      </div>
                                              </div>
                                              ...
                                              <div class="col ">
                                                    <div class="vl-home-thumb">
                                                      ...
                                                      <div class="btn-area1">
                                                        ...
                                                        <div class="space16"></div>
                                                        <a href="single-index5" target="_blank" class="vl-btn6">One Page <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                                                       </div>
                                                    </div>
                                            </div>
                                          </div>
