      ...
      <div class="row">
        <div class="col-lg-6 m-auto">
          <div class="inner-header text-center heading1">
            <h1>Blog Details Sidebar</h1>
            <div class="space28"></div>
            <a href="index">Home <i class="fa-solid fa-angle-right"></i> Our Blog <i class="fa-solid fa-angle-right"></i> <span>Blog Details Sidebar</span></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 m-auto">
          <div class="blog-others-sidebar" style="padding: 0 !important;">
            <div class="img1">
