          ...
          <div class="case-slider-widget owl-carousel">
            <div class="case-slider-boxarea">
              ...
              <div class="content-area">
                ...
                <div class="space16"></div>
                <a href="service-single">Upgrading IT for Financial Secure</a>
                <div class="arrow">
                  <a href="service-single"><i class="fa-solid fa-arrow-right"></i></a>
                </div>
              </div>
            ...
            <div class="case-slider-boxarea">
              ...
              <div class="content-area">
                <p>#CloudFlex Solution</p>
                <div class="space16"></div>
                <a href="service-single">Scaling IT for EcoSolutions</a>
                <div class="arrow">
                  <a href="service-single"><i class="fa-solid fa-arrow-right"></i></a>
                </div>
              </div>
            ...
            <div class="case-slider-boxarea">
              ...
              <div class="content-area">
                <p>#CloudFlex Solution</p>
                <div class="space16"></div>
                <a href="service-single">Optimizing IT For Solutions</a>
                <div class="arrow">
                  <a href="service-single"><i class="fa-solid fa-arrow-right"></i></a>
                </div>
              </div>
