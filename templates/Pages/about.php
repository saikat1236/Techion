...
<body>
      ...
      <div class="row">
        <div class="col-lg-4 m-auto">
          <div class="inner-header text-center heading1">
            ...
            <a href="index">Home <i class="fa-solid fa-angle-right"></i> <span>About Us</span></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!--===== ABOUT AREA STARTS =======-->
  <div class="about6-section-area-widget sp1">
    <div class="container">
      <div class="row">
        <div class="col-lg-5">
          <div class="about6-header heading2">
            <h5><span><img src="/img/icons/sub-logo1.svg" alt=""></span>our mission/vision</h5>
            <div class="space18"></div>
            <h2 class="text-anime-style-3">Driving Innovation: Our Mission Vision at FeynHomi</h2>
            <div class="space16"></div>
            ...
            <div class="about-boxarea" data-aos="fade-left" data-aos-duration="1000">
              ...
              <div class="content-area">
                <a href="service-single">Network Infrastructure Solutions</a>
                <div class="space16"></div>
            ...
            <div class="about-boxarea" data-aos="fade-left" data-aos-duration="1100">
              ...
              <div class="content-area">
                <a href="service-single">Performance Tailored IT Services</a>
                <div class="space16"></div>
